...
const menuItems = [
  ...
  { title: "Permissões", icon: Shield, url: "/permissoes" },
  { title: "Configurações", icon: Settings, url: "/configuracoes" },
  { title: "Squads", icon: Users, url: "/squads" },
];
            ...
            <SidebarMenuButton size="lg" asChild className="data-[slot=sidebar-menu-button]:!p-1.5">
              <a href="/">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold text-base">HUB SOTEC</span>
                </div>
              </a>
            </SidebarMenuButton>
          </SidebarMenuItem>
              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <div className="grid flex-1 text-left text-sm leading-tight">
                    ...
                    <span className="truncate text-xs">admin@sotec.com</span>
                  </div>
                </SidebarMenuButton>
              </DropdownMenuTrigger>
              <DropdownMenuContent
